...
<html lang="en">
  ...
  <body>
      ...
      *********************************************************************************************************************************************************** -->
	  ...
	  <div id="login-page">
	  	<div class="container">
		      ...
		      <form class="form-login" action="<?php echo $baseUrl; ?>/back/user/form_login" method="post">
    ...
    <script type="text/javascript" src="<?php echo $baseUrl; ?>/assets/js/jquery.backstretch.min.js"></script>
    <script>
        $.backstretch("<?php echo $baseUrl; ?>/assets/img/login-bg.jpg", {speed: 500});
    </script>
